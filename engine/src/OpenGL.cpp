...
FramebufferParams OpenGL::m_framebuffer_params;
...
void OpenGL::create_framebuffer(int SCR_WIDTH, int SCR_HEIGHT) {
    ...
    CHECKED_GL_CALL(glGenTextures, 1, &m_framebuffer_params.textureColorBuffer);
    CHECKED_GL_CALL(glBindTexture, GL_TEXTURE_2D, m_framebuffer_params.textureColorBuffer);
    ...
    CHECKED_GL_CALL(glTexParameteri, GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    CHECKED_GL_CALL(glFramebufferTexture2D, GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, m_framebuffer_params.textureColorBuffer, 0);
...
void OpenGL::destroy_framebuffer() {
    ...
    CHECKED_GL_CALL(glDeleteTextures, 1, &m_framebuffer_params.textureColorBuffer);
...
void OpenGL::unbind_framebuffer() {
    CHECKED_GL_CALL(glBindFramebuffer, GL_FRAMEBUFFER, 0);
